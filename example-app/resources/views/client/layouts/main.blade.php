    ...
    <div class="wrap-slick1">
        <div class="slick1">
            @foreach ($slider as $slide)
                <div class="item-slick1" style="background-image: url({{ Storage::url($slide->image) }});">
        ...
        <div class="row">
            <div class="col-sm-10 col-md-8 col-lg-4 m-l-r-auto">
                ...
                <div class="block1 hov-img-zoom pos-relative m-b-30">
                    <img src="{{ asset('client/images/banner-02.jpg') }}" alt="IMG-BENNER">
                ...
                <!-- block1 -->
                <div class="block1 hov-img-zoom pos-relative m-b-30">
                    <img src="{{ asset('client/images/banner-05.jpg') }}" alt="IMG-BENNER">
            ...
            <div class="col-sm-10 col-md-8 col-lg-4 m-l-r-auto">
                <!-- block1 -->
                <div class="block1 hov-img-zoom pos-relative m-b-30">
                    <img src="{{ asset('client/images/banner-03.jpg') }}" alt="IMG-BENNER">
                ...
                <!-- block1 -->
                <div class="block1 hov-img-zoom pos-relative m-b-30">
                    <img src="{{ asset('client/images/banner-07.jpg') }}" alt="IMG-BENNER">
            ...
            <div class="col-sm-10 col-md-8 col-lg-4 m-l-r-auto">
                <!-- block1 -->
                <div class="block1 hov-img-zoom pos-relative m-b-30">
                    <img src="{{ asset('client/images/banner-04.jpg') }}" alt="IMG-BENNER">
        ...
        <div class="row">
            ...
            <div class="col-sm-10 col-md-8 col-lg-6 m-l-r-auto p-t-15 p-b-15">
                <div class="bgwhite hov-img-zoom pos-relative p-b-20per-ssm">
                    <img src="{{ asset('client/images/shop-item-09.jpg') }}" alt="IMG-BANNER">
            ...
            <div class="col-sm-10 col-md-4 p-b-30 m-l-r-auto">
                ...
                <div class="block3">
                    <a href="blog-detail.html" class="block3-img dis-block hov-img-zoom">
                        <img src="{{ Storage::url($value->cover_image) }}" alt="IMG-BLOG">
                    </a>
                    ...
                    <div class="block3-txt p-t-14">
                        ...
                        <span class="s-text6">By</span> <span class="s-text7">{{ $value->user->name }}</span>
                        <span class="s-text6">on</span> <span class="s-text7">{{ $value->created_at }}</span>

                        <p class="s-text8 p-t-16">
                            <?=   Str::limit($value->content ,150,'...')  ?>
                        </p>
                    </div>
                </div>
            </div>
