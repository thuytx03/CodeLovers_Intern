    ...
    @endif
        ...
        <form action="{{ route('saveAdd.user') }}" method="post">
            ...
            <div class="form-group mt-2">
                ...
                <input id="my-input" class="form-control" type="email" name="email" placeholder="Vui lòng nhập email" value="{{ old('email') }}">
            </div>
            ...
            <div class="form-group mt-2">
                ...
                <input id="my-input" class="form-control" type="text" name="phone" placeholder="Vui lòng nhập số điện thoại" value="{{ old('phone') }}">
            </div>
            <div class="form-group mt-2">
                <label for="my-input">Địa chỉ</label>
                <input id="my-input" class="form-control" type="text" name="address" placeholder="Vui lòng nhập số địa chỉ" value="{{ old('address') }}">
            </div>
            <div class="form-group mt-2">
