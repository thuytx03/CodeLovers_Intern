...
@section('content')
    ...
    @endif
        ...
        <form action="{{ route('update.slider',['id'=>$data->id]) }}" method="post" enctype="multipart/form-data">
            ...
            <div class="form-group mt-3">
                ...
                <img id="preview-image" class="mt-3 " src="{{ Storage::url($data->image) }}" alt="Ảnh sản phẩm"
