...
@section('content')
    ...
    @endif
    <form action="{{ route('restore.types') }}" method="post" id="restore-form">
        <div class="d-flex justify-content-end mt-3 mb-3">
            <div class="dropdown">
                ...
                <ul class="dropdown-menu">
                    ...
                    <li><a class="dropdown-item" href="{{ route('list.types') }}">Danh sách danh mục</a></li>
                </ul>
            </div>
        </div>
        @csrf
                ...
                <tbody>
                    @foreach ($types as $key => $item)
                        <tr>
                            ...
                            <td>
                                <?php $typeUrl = '/admin/types/permanentlyDelete/'; ?>
                                <a href="/admin/types/permanentlyDelete/{{ $item->id }}" class="btn btn-danger"
