...
class VNPay
{
     ...
     *
     */
    static $vnp_TmnCode = "AF8BO2WP"; //Mã website tại VNPAY
    static $vnp_HashSecret = "GVZPZIFNRNHMIHDOASMPXNYPYAIXWHZV"; //Chuỗi bí mật
    ...
    //         $vnpSecureHash = hash('sha512', self::$vnp_HashSecret . $hashdata);
    ...
    public static function vnpay(array $data)
    {
        error_reporting(E_ALL & ~E_NOTICE & ~E_DEPRECATED);
        ...
        static $vnp_HashSecret = "GVZPZIFNRNHMIHDOASMPXNYPYAIXWHZV"; //Chuỗi bí mật
        static $vnp_Url = "http://sandbox.vnpayment.vn/paymentv2/vpcpay.html";
        static $vnp_Returnurl = "http://127.0.0.1:8000/vnPayCheck";
